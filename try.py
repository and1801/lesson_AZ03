...
for vacancy in vacancies:
    try:
        title_element = vacancy.find_element(By.CSS_SELECTOR, 'a.magritte-text___tkzIl_4-3-16')
        #<span data-qa="serp-item__title-text" class="magritte-text___tkzIl_4-3-16">Программист</span>
